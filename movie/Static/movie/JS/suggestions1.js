...
document.getElementById('searchBox1').addEventListener('keyup', function(){
	...
	var cleanInput = document.getElementById('searchBox1').value.replace(/\s/g, "");
...
function fill1(destinationUrl){
	document.getElementById('searchBox1').value = destinationUrl;
	document.getElementById('result1').innerHTML = "";
}