...
document.getElementById('searchBox3').addEventListener('keyup', function(){

	//clearing blank spaces from input
	var cleanInput = document.getElementById('searchBox3').value.replace(/\s/g, "");
...
function fill3(destinationUrl){
	document.getElementById('searchBox3').value = destinationUrl;
	document.getElementById('result3').innerHTML = "";
}